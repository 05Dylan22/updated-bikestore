    ...
    <div ref={popup} className="icon-container">
      ...
      <div className="search-list-div">
        <ul className="search-list">
          {matchedTerms.map((result) => <Link key={result.term} state={result.state} to={result.sendTo} className="search-list-item"><li className="search-item-text">{result.term}</li></Link>)}
        </ul>
      </div>
    </div>
  )
