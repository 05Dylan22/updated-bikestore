...
const LargeHeader = ({fillHeart, emptyHeart, heartHover, dispatch}) => {
  ...
  return (
    <header className="large-header">
      ...
      <img onClick={() => dispatch({payload: {identifier: "PROFILE", component: <Profile dispatch={dispatch}/>}})} alt="profile icon" className="large-profile-icon" src={imagesIcons.profileIcon}/>
