...
const LargeHeader = () => {
  ...
  return (
    <header className="large-header">
      ...
      <img onClick={() => dispatch({payload: {identifier: "WISHLIST", component: <Wishlist bikes={state.wishlist}/>}})} onMouseLeave={emptyHeart} onMouseOver={fillHeart} alt="heart icon outline" className="large-wishlist-icon" src={heartHover}/>
